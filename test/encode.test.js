...
describe('encode - Functional Check', function () {
    ...
    it('#.encode(tlv)', function () {
        ...
        expect(encode('tlv', '/temperature', {0: {sensorValue: 31, 5701: 'c'}, 1:{5700: 89, 5701: 'f'}})).to.be.eql(cutils.bufferFrom([0x08, 0x00, 0x0b, 0xe4, 0x16, 0x44, 0x41, 0xf8, 0x00, 0x00, 0xe1, 0x16, 0x45, 0x63, 0x08, 0x01, 0x0b, 0xe4, 0x16, 0x44, 0x42, 0xb2, 0x00, 0x00, 0xe1, 0x16, 0x45, 0x66]));
